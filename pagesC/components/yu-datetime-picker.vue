<template>
	<view class="yu-datetime-picker">
		<view class="yu-datetime-mask" :class="{'show':showPicker}" @tap="pickerCancel" @touchmove.stop.prevent catchtouchmove="true"></view>
		<view class="yu-datetime-content" :class="{'show':showPicker}">
			...
			<view class="yu-datetime-view">
				...
				<picker-view class="picker-view" v-else :indicator-style="itemHeight" :value="dateValues" @change="bindDateChange">
